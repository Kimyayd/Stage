...
public class CompanyRegister extends AppCompatActivity {
    ...
    private String email, ifunumber,fullname, password,cpassword;
    ...
    private void initWidgets(){
        ...
        mEmail = findViewById(R.id.org_email);
        mFullname =  findViewById(R.id.org_name);
        mSignUp =  findViewById(R.id.signup);
        mSignIn =  findViewById(R.id.txt_signin);
        mProgressBar =  findViewById(R.id.progressBar);
        mPassword =  findViewById(R.id.org_pass);
        mCPassword =  findViewById(R.id.org_cpass);
        mContext = CompanyRegister.this;
            ...
            if (user != null) {
                ...
                myRef.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        firebaseMethods.addNewUserCompany(email,fullname,"organisation");
